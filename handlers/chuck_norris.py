...
class handler:
    """
    Watch for mentions of Chuck Norris and respond with random Chuck fact.
    """
    ...
    def __init__ (self, bot):
        ...
        # register triggers.
        self.bot.register_trigger(self.chuck_norris, "regex", "(?i).*(chuck.norris|wwcnd).*")


    ####################################################################################################################
    def chuck_norris (self, xmpp_message, room, nick, message):
        return random.choice(chuck_facts)
